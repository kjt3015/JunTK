...
$sql = "SELECT * FROM carList WHERE carStatus='예약불가'";
...
$main_page = '
<a class="id" href="./Return.php?id=' . $myarray[0]['id'] . '">
...
$empty_page = '
<img class="carImg" src="./img/Icon/empty.png" alt="img" style="height: 150px; width: 150px;">

<div class="car_info">
    <div class="carName">Empty</div>
    <div class="carNumber">반납가능 차량이 없습니다</div>
</div>
';
?>
...
<head>
    ...
    <script>
        ...
        function showNext() {
            ...
            carId_class.href = "./Return.php?id=" + my_data[i]["id"];
